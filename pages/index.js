    ...
    <main className={styles.main}>
      ...
      <div className={styles.container}>
        <form onSubmit={addTask} className={styles.form_container}>
          <input className={styles.input} type='text' placeholder='Task to be done...' onChange={handleChange} value={task.task} />
        ...
        {tasks.map((task) => (
          <div className={styles.task_container} key={task._id}>
            <input type='checkbox' className={styles.check_box} checked={task.completed} onChange={() => updateTask(task._id)} />
            <p className={task.completed ? styles.task_text + ' ' + styles.line_through : styles.task_text}>{task.task}</p>
